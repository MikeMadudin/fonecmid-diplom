...
// Процедура заполняет график работы
//
// Параметры:
// ДатаНачала - Дата
// ДатаОкончания - Дата
// ВыходныеДни - Строка - Список номеров выходных дней в неделе
// ГрафикРаботы - СправочникСсылка.ВКМ_ГрафикиРаботы - Ссылка на график работы
