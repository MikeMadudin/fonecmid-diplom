...
//		|	ВКМ_УдержанияБазаВКМ_ОсновныеНачисления.СотрудникРазрез КАК СотрудникРазрез
		|ИЗ
...
//	Разрезы.Добавить("СотрудникРазрез");
...
//		Движение.Результат = Выборка.Результат - (Выборка.Результат * 0.87);
//	КонецЦикла;
//
